    ...
    <div class="sm:ml-64">
            ...
            <div class="gap-4 ">
                <div class="">
                    <div class="">
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse p-4 mt-2">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">List
                                            Office Boy</span>
                                    </div>
                                </li>
                            </ol>
                        ...
                        @endif
                        <!-- Search Form -->
                        <form action="{{ route('kabag-urdal.index') }}" method="GET" class="mb-4">
                            <div class="px-4">
                        ...
                        <table
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">NIK</th>
                            ...
                            <tbody>
                                @foreach ($officeBoys as $key => $officeBoy)
                                    <tr class="hover:bg-gray-700">
                                        ...
                                        <td <td
                                            ...
                                            <div x-data="{ open: false }">
                                                ...
                                                <div x-show="open" @mouseover="open = true"
                                                    ...
                                                    class="absolute right-24 mr-24 top-0 w-64 text-sm text-gray-300 transition-opacity duration-300 bg-gray-600 border border-gray-400 rounded-lg shadow-sm">
                                                    <div
                                        ...
                                        <td class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                            <a href="{{ route('kabag-urdal.office-boys.show', $officeBoy->id) }}"
        ...
        <script>
            function showConfirmationModal(id) {
                ...
                form.action = "{{ url('/kabag-urdal') }}/" + id;
