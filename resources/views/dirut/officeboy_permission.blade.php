                        ...
                        <ul id="dropdown-example" class="py-2 space-y-2">
                            ...
                            <li>
                                <a href="/kabag-urdal/index/permission"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:bg-gray-700">Perizinan
                                    Office Boy</a>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="gap-4 mb-4">
                <div class="">
                    <div class="my-2">
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse p-4 mt-2">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Perizinan
                                            Office Boy</span>
                                    </div>
                                </li>
                            </ol>
                        ...
                        <!-- Breadcrumbs End -->
                        <h2 class="text-2xl font-bold text-white px-4">Daftar Izin Keluar</h2>
                        @if (session('success'))
                        ...
                        <div class="flex items-center mt-2 mb-4 justify-between">
                            <div class="px-4">
                                <form method="GET" action="{{ route('kabag-urdal.indexForm') }}">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <button type="submit"
                                            class="ml-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300 mt-2">
                                            Cari
                                        </button>
                                    </div>
                                </form>
                            ...
                            <table
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">Jam
                                            Keluar</th>
                                        <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">
                                            Keperluan</th>
                                        <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">Jam
                                    ...
                                    @foreach ($izinKeluars as $izinKeluar)
                                        <tr class="hover:bg-gray-700">
                                            <td
                                                ...
                                                {{ $izinKeluar->tanggal }}</td>
                                            <td
                                                class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                                {{ $izinKeluar->nama }}</td>
                                            <td
                                                class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                                {{ $izinKeluar->jam_keluar }}</td>
                                            <td
                                                class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                                {{ $izinKeluar->keperluan }}</td>
                                            <td
                                                class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                                {{ $izinKeluar->jam_masuk ?? 'N/A' }}</td>
                                            <td
                                                class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                                <div x-data="{ open: false }" class="relative">
                                                    @if ($izinKeluar->status === 'Belum Kembali')
                                                    ...
                                                    @elseif ($izinKeluar->status === 'Sudah Kembali')
                                                        <button @mouseover="open = true" @mouseleave="open = false"
                                                    ...
                                                    <div x-show="open" @mouseover="open = true"
                                                        ...
                                                        class="absolute right-24 top-1/2 transform -translate-y-1/2 w-64 text-sm text-gray-300 transition-opacity duration-300 bg-gray-600 border border-gray-400 rounded-lg shadow-sm z-10">
                                                        <div
                                                            class="px-3 py-2 bg-gray-700 border-b border-gray-400 rounded-t-lg">
                                                            <h3 class="font-semibold text-white">Status:
                                                                {{ $izinKeluar->status }}</h3>
                                                        </div>
                                                        <div class="px-3 py-2">
                                                            @if ($izinKeluar->status === 'Belum Kembali')
                                                                <p>Office Boy Belum Kembali</p>
                                                            @elseif ($izinKeluar->status === 'Sudah Kembali')
                                                                <p>Office Boy Sudah Kembali</p>
                                                            @else
