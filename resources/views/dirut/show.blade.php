        ...
        <div class="mt-16">
            <div class="gap-4 mb-4">
                <div class="">
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse mt-2 mb-4">
                            ...
                            <li>
                                <div class="flex items-center">
                                    ...
                                    <a href="/kabag-urdal/office-boys-index"
                                        class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">List
                                        Office Boy</a>
                                </div>
                            </li>
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Profil
                                        Office Boy</span>
                                </div>
                            </li>
                        </ol>
                    ...
                    <!-- Breadcrumbs End -->
                    <!-- Foto Profil -->
                    <div class="bg-gray-700 p-4 mb-6 rounded-md flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-gray-100"><strong>Nama Lengkap:</strong> {{ $officeBoy->nama_lengkap }}</p>
                            <p class="text-gray-100"><strong>Tahun Masuk:</strong>
                                {{ $officeBoy->tahun_masuk ?? 'Belum diatur' }}</p>
                    ...
                    {{-- <a href="{{ url('/kabag-urdal/office-boys-index') }}"
                        class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 rounded-lg px-4 py-2 dark:bg-red-500 dark:hover:bg-red-700 dark:focus:ring-red-900">
                        Kembali
                    </a> --}}
                </div>
            </div>
