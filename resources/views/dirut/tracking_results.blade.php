                        ...
                        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse ml-4">
                            <p class="relative inline font-inter font-normal text-transparent text-18 leading-normal">
                                <span type="text-wrapper text-white"
                                    class="text-white font-medium rounded-lg text-sm text-center">Halo,
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    ...
                    <ul id="dropdown-example-1" class="py-2 space-y-2">
                        <li>
                            <a href="/kabag-urdal/office-boys-index"
                ...
                <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    <li>
                        ...
                        <ul id="dropdown-example" class="py-2 space-y-2">
                            <li>
                                <a href="/importOfficeBoy"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Import
                                    Excel
                                </a>
                            </li>
                            <li>
                                <a href="/createOfficeBoy"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Registrasi
                                    Office Boy
                                </a>
                            </li>
                            <li>
                                <a href="/kabag-urdal/monitorings"
                            ...
                            <li>
                                <a href="/kabag-urdal/index/permission"
                    ...
                    <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                        <li>
                            <a href="/kabag-urdal/tracking-results"
                                class="flex items-center p-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group dark:bg-gray-700">
            ...
            <div class="gap-4 mb-4">
                <div class="">
                    ...
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse mt-6 mb-4 px-4">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Riwayat
                                        Catatan</span>
                                </div>
                            </li>
                        </ol>
                    ...
                    <!-- Breadcrumbs End -->
                    <h2 class="text-2xl font-bold mb-4 text-white px-4">Hasil Tracking Office Boy</h2>
                    <!-- Search Form -->
                    <form action="{{ route('kabag.tracking-results') }}" method="GET">
                        <div class="px-4 mb-4">
                            <input type="text" name="search" placeholder="Cari Office Boy"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 py-2.5">
                            <button type="submit"
                    ...
                    <div class="overflow-x-auto">
                        <table
                            ...
                            <thead>
                                <tr>
                                    <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">No</th>
                                    <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">Nama
                                        Ofiice Boy</th>
                                    <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">Sumber
                                        Informasi</th>
                                    <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">Gedung
                                    </th>
                                    <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">Lantai
                                    </th>
                                    <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">Ruangan
                                    </th>
                                    <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">Date</th>
                                    <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">Catatan
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($trackings as $index => $tracking)
                                    <tr class="hover:bg-gray-700">
                                        <td class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                            {{ $index + 1 }}
                                        <td class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                            {{ $tracking->officeBoy->nama_lengkap }}
                                        </td>
                                        <td class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                            {{ $tracking->sumber_informasi }}</td>
                                        <td class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                            {{ $tracking->building->name }}</td>
                                        <td class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                            {{ $tracking->floor->name }}</td>
                                        <td class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                            {{ $tracking->room->name }}</td>
                                        <td class="py-6 px-4 mb-2 text-center border-b border-gray-600 bg-transparent">
                                            {{ $tracking->date }}</td>
                                        <td class="py-1 px-2 mb-2 text-center border-b border-gray-600 relative">
                                            <div x-data="{ open: false }">
                                                <!-- Tombol untuk membuka detail tugas -->
                                                <button @click="open = true"
                                                    class="flex items-center justify-center bg-blue-500 text-white rounded-full w-6 h-6 mx-auto">
                                                ...
                                                {{-- Popover untuk detail tugas --}}
                                                <div x-show="open" @click.away="open = false"
                                                    class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
                                                    <div class="bg-slate-700 p-8 rounded-lg shadow-lg">
                                                        <!-- Tampilkan catatan tracking -->
                                                        <p class="mb-4"><strong>Catatan:</strong>
                                                            {{ $tracking->catatan ?? 'Tidak ada catatan' }}
                                                        </p>
                                                        <!-- Tombol untuk menutup detail tugas -->
                                                        <button @click="open = false"
                                                            class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 rounded-lg px-4 py-2 dark:bg-blue-500 dark:hover:bg-blue-700 dark:focus:ring-blue-900 ml-2 px-4 py-2">Tutup</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
