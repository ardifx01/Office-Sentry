...
<body class="bg-gray-900 m-auto">
    ...
    <div class="p-4 sm:ml-64">
        <div class="mt-16">
            <div class="gap-4 mb-4">
                ...
                {{-- Jumbotron Start --}}
                <div class="w-full bg-gray-800 rounded-lg border border-gray-700 py-2 px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-4 w-auto">
                    ...
                    <div class="flex justify-between items-center pt-3">
                        <div class="flex items-center space-x-3">
                            ...
                            <button onclick="updateChart()"
                                class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 mt-2">Filter</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-8">
                ...
                <form method="GET" action="{{ route('kabag_urdal.dashboard') }}" class="mb-4">
    ...
    <script>
        function updateChart() {
            ...
            window.location.href = `/dashboard/kabag_urdal?start_date=${startDate}&end_date=${endDate}`;
        }
    </script>
