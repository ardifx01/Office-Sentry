...
<head>
    ...
    <title>Daftar Izin Keluar</title>
                        ...
                        <ul id="dropdown-example" class="py-2 space-y-2">
                            ...
                            <li>
                                <a href="/officeboy/create"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:bg-gray-700">Form
                                    Perizinan
                                </a>
        ...
        <div class="mt-16">
            <div class="gap-4 mb-4">
                <div class="">
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse mt-2 mb-4">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Form
                                        Perizinan</span>
                                </div>
                            </li>
                        </ol>
                    ...
                    <!-- Breadcrumbs End -->
                    <h2 class="text-2xl font-bold mb-4 text-white">Form Izin Keluar</h2>
                    @if (session('success'))
                    ...
                    <form action="{{ route('officeboy.storeForm') }}" method="POST">
                        @csrf
                        <div>
                            <label class="block text-sm font-medium text-gray-600 mb-1" for="tanggal">Tanggal</label>
                            <input type="date"
                                ...
                                id="tanggal" name="tanggal" value="{{ now()->toDateString() }}" readonly>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-600 mb-1" for="nama">Nama</label>
                            <input type="text"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-slate-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-slate-500 dark:focus:ring-slate-500 dark:focus:border-slate-500 w-full p-2.5 mb-4"
                                id="nama" name="nama" value="{{ $officeBoy->nama_lengkap }}" readonly>
                        </div>
                        <div>
                            ...
                            <textarea
                                ...
                                id="keperluan" name="keperluan" rows="3" required></textarea>
                        </div>
                        <button type="submit"
                            class="px-4 py-2 bg-blue-500 hover:bg-blue-700 rounded-lg text-white focus:outline-none focus:ring focus:border-blue-300">Submit</button>
                    </form>
                </div>
            </div>
        </div>
