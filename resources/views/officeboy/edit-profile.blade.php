            ...
            <div class="gap-4 mb-4">
                <div class="">
                    ...
                    <form method="POST" action="{{ url('/office-boy/update-profile') }}"
                        ...
                        <div class="mb-4">
                            <label for="foto_profil" class="block text-sm font-medium text-gray-600">Foto
                                Profil:</label>
                            <input type="file" name="foto_profil"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full">
                        </div>
                        <div class="flex item-center mt-4">
                            <button type="submit"
                                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline-blue focus:border-blue-300">
                                Update Profil
                            </button>
                        </div>
                    </form>
