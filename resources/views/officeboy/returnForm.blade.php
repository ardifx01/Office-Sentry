                        ...
                        <ul id="dropdown-example" class="py-2 space-y-2">
                            ...
                            <li>
                                ...
                                <a href="/officeboy/return"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:bg-gray-700 mt-2">Form
                                    Kembali
                                </a>
                            </li>
                        </ul>
        ...
        <div class="mt-16">
            <div class="gap-4 mb-4">
                <div class="">
                    ...
                    @if ($izinKeluar)
                        <form action="{{ route('officeboy.markReturned', $izinKeluar->id) }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    id="nama" name="nama" value="{{ $izinKeluar->nama }}" readonly>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-600 mb-1"
                                    for="keperluan">Keperluan</label>
                                <textarea
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-slate-500 focus:border-slate-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-slate-500 dark:focus:border-slate-500 w-full p-4 h-24 mb-4"
                                    id="keperluan" name="keperluan" rows="3" readonly>{{ $izinKeluar->keperluan }}</textarea>
                            </div>
                            <button type="submit"
                                class="px-4 py-2 bg-blue-500 hover:bg-blue-700 rounded-lg text-white focus:outline-none focus:ring focus:border-blue-300">Tandai
                                Sudah Kembali</button>
                        </form>
                    @else
                        <p class="text-gray-600">Tidak ada izin keluar yang belum kembali.</p>
                    @endif
