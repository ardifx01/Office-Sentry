                        ...
                        <ul id="dropdown-example" class="py-2 space-y-2">
                            ...
                            <li>
                                <a href="/createOfficeBoy"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:bg-gray-700">Registrasi
                                    Office Boy
                                </a>
                            </li>
                            <li>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse mt-2 mb-4">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Registrasi
                                        Office Boy
                                </div>
                            </li>
                        </ol>
                    ...
                    <form method="POST" action="{{ url('/store-office-boy') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" name="password" id="password"
                                ...
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-slate-500 focus:border-slate-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-slate-500 dark:focus:border-slate-500 w-full p-2.5">
                        </div>
                        <div class="mb-8">
                        ...
                        <div class="flex item-center">
                            <button type="submit"
                                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline-blue focus:border-blue-300">Buat
                                Akun</button>
                        </div>
                    </form>
                </div>
