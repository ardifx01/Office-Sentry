        ...
        <div class="mt-16">
            <div class="gap-4 mb-4">
                <div class="">
                    ...
                    <!-- Breadcrumbs End -->
                    <h2 class="text-2xl font-bold mb-2 text-white px-4">Hasil Tracking Office Boy</h2>
                    <!-- Form untuk pencarian tanggal -->
                    <form action="{{ route('officeboy.trackings') }}" method="GET" class="mb-4 px-4">
                        ...
                        <button type="submit"
                            class="mt-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 ml-1">Search</button>
                    </form>
                    @if (session('success'))
                        ...
                        <table
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="py-4 px-4 border-b border-gray-500 bg-gray-700 text-gray-400">Tanggal
                                    </th>
                    ...
                    {{-- <div class="flex item-center">
                        <a href="{{ url('dashboard/office-boy') }}"
                            class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 rounded-lg px-4 py-2 dark:bg-red-500 dark:hover:bg-red-700 dark:focus:ring-red-900 mt-4">
                            Kembali
                        </a>
                    </div> --}}
                </div>
