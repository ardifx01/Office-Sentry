                        ...
                        <ul id="dropdown-example" class="py-2 space-y-2">
                            <li>
                                <a href="/pengawas/tracking"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:bg-gray-700">Tracking
                                </a>
                            </li>
                            <li>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse mt-2 mb-4">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Tracking
                                        OB</span>
                                </div>
                            </li>
                        </ol>
                    ...
                    <form action="{{ route('pengawas.trackings') }}" method="POST" class="">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="catatan" name="catatan"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full p-4 h-24 @error('catatan') border-red-500 @enderror"
                                required></textarea>
                            @error('catatan')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="flex item-center mb-6">
                            <button type="submit"
                                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline-blue focus:border-blue-300">Kirim
                                Form</button>
                            {{-- <a href="/pengawas/tracking-results"
                                class="bg-cyan-500 text-white px-4 py-2 rounded-lg hover:bg-cyan-600 focus:outline-none focus:ring focus:border-cyan-300 ml-2">
                                Riwayat Catatan
                            </a> --}}
                            {{-- <a href="{{ url('/dashboard/pengawas') }}"
                                class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 rounded-lg px-4 py-2 dark:bg-red-500 dark:hover:bg-red-700 dark:focus:ring-red-900 ml-2">
                                Kembali
                            </a> --}}
                        </div>
                    </form>
