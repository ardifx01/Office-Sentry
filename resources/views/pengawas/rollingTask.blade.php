                        ...
                        <ul id="dropdown-example" class="py-2 space-y-2">
                            ...
                            <li>
                                <a href="/pengawas/rolling-task"
                                    class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:bg-gray-700">Rolling
                                    Tugas
                                </a>
                            </li>
                            <li>
            ...
            <div class="gap-4 mb-4">
                <div class="mt-12 py-4">
                    <div class="">
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse mt-2 mb-4">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Rolling
                                            Tugas</span>
                                    </div>
                                </li>
                            </ol>
                        ...
                        <!-- Breadcrumbs End -->
                        <h2 class="text-2xl font-bold mb-4 text-white">Tentukan Tugas Office Boy Anda Secara Acak!
                        </h2>
                        @if (session('success'))
                        ...
                        @endif
                        <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">Dengan algoritma khusus
                            yang dikembangkan, kami menetapkan tugas
                            office boy secara acak untuk memberikan pengalaman yang adil dan merata bagi semua office
                            boy. Berikut adalah bagaimana prosesnya berjalan:</p>
                        <ol class="list-decimal text-lg font-normal text-gray-500 dark:text-gray-400 mb-6 ml-6">
                            <li>Pertama, kami mengambil daftar semua office boy yang tersedia.</li>
                            <li>Selanjutnya, kami menentukan tanggal tugas berikutnya, yang secara otomatis diatur untuk
                                besok.</li>
                            <li>Kami melakukan iterasi melalui daftar office boy yang tersedia.</li>
                            <li>Untuk setiap office boy, kami memeriksa apakah mereka sudah memiliki tugas di tanggal
                                yang ditentukan.</li>
                            <li>Jika tidak, kami melanjutkan dengan mencari ruangan yang memenuhi syarat untuk tugas
                                baru. Ruangan harus memiliki kapasitas tersedia dan belum diisi oleh office boy yang
                                bersangkutan.</li>
                            <li>Setelah menemukan ruangan yang sesuai, kami secara acak memilih shift yang cocok untuk
                                tugas tersebut.</li>
                            <li>Terakhir, kami membuat catatan baru untuk tugas office boy dengan informasi yang sesuai,
                                seperti ID office boy, ID gedung, ID lantai, ID ruangan, ID shift, tanggal, dan status
                                tugas.</li>
                            <li>Seluruh proses ini dijalankan dalam transaksi database untuk memastikan konsistensi dan
                                keamanan data.</li>
                        </ol>
                    </div>
                    <div class="flex justify-center">
                        <a href="{{ route('assign.random') }}"
                            class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 px-8 rounded-lg shadow-lg focus:outline-none focus:shadow-outline">
                            Generate Secara Acak
                        </a>
                    </div>
                </div>
            </div>
