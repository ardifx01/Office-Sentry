                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse mt-2 mb-4">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Edit
                                        OB</span>
                                </div>
                            </li>
                        </ol>
                    ...
                    <form method="POST" action="{{ route('pengawas.update', $officeBoy->id) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nik" value="{{ $officeBoy->nik }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-slate-500 focus:border-slate-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-slate-600 dark:focus:ring-slate-500 dark:focus:border-slate-500 w-full p-2.5"
                                readonly>
                        </div>
                        <div class="mb-4">
                            <label for="nama_lengkap" class="block text-sm font-medium text-gray-600 mb-1">Nama
                                Lengkap:</label>
                            <input type="text" name="nama_lengkap" value="{{ $officeBoy->nama_lengkap }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-slate-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-slate-600 dark:focus:ring-slate-500 dark:focus:border-slate-500 w-full p-2.5"
                                readonly>
                        </div>
                        <div class="mb-4">
                            <label for="tahun_masuk" class="block text-sm font-medium text-gray-600 mb-1">Tahun
                                Masuk:</label>
                        ...
                        <div class="mb-4">
                            <label for="tempat_lahir" class="block text-sm font-medium text-gray-600 mb-1">Tempat
                                Lahir:</label>
                        ...
                        <div class="mb-4">
                            <label for="tanggal_lahir" class="block text-sm font-medium text-gray-600 mb-1">Tanggal
                                Lahir:</label>
                        ...
                        <div class="mb-4">
                            <label for="no_telepon" class="block text-sm font-medium text-gray-600 mb-1">No
                                Telepon:</label>
                        ...
                        <div class="mb-4">
                            <label for="password" class="block text-sm font-medium text-gray-600 mb-1">Password
                                Baru:</label>
